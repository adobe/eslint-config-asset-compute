...
module.exports = {
    ...
    "rules": {
        ...
        // - OFF: tests defined using () => {} notation do not have access to globals
        //   The globals are only required to override a setting like timeout, which is not 
        //   very common so the arrow functions are fine most of the time.
